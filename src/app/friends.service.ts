...
export class FriendsService {
  ...
  addFriend(username: string, friendUsername: string) {
    return this.http.post(`${this.apiUrl}/friends/add`, {
      username,
      friendUsername,
    });
  }
  ...
  acceptFriendRequest(username: string, friendUsername: string) {
    return this.http.post(`${this.apiUrl}/friends/accept`, {
      username,
      friendUsername,
    });
  }
  ...
  deleteFriendRequest(username: string, friendUsername: string) {
    return this.http.post(`${this.apiUrl}/friends/delete`, {
      username,
      friendUsername,
    });
  }
  ...
  unfriend(username: string, friendUsername: string) {
    return this.http.post(`${this.apiUrl}/friends/unfriend`, {
      username,
      friendUsername,
    });
  }
