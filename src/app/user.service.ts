...
export class UserService {
  ...
  getUserData(username: string): Observable<any> {
    ...
    return this.http.get(`${this.apiUrl}/account/userdata?username=${username}`).pipe(
  ...
  updateUserData(userData: any): Observable<any> {
    ...
    return this.http.put(`${this.apiUrl}/account/updatedata`, userData).pipe(
      catchError(this.handleError)
    );
  }
  ...
  getUserPrivacy(username: string): Observable<any> {
    ...
    return this.http.get(`${this.apiUrl}/account/fetchprivacy/${username}`).pipe(
      catchError(this.handleError)
    );
  }
  ...
  updateUserPrivacy(username: string, newPrivacy: string): Observable<any> {
    ...
    return this.http
      .post(`${this.apiUrl}/account/updateprivacy/${username}`, { privacy: newPrivacy })
      .pipe(catchError(this.handleError));
  }

  deleteUserAccount(username: string): Observable<any> {
    // Define a method to delete the user's account on the server
    return this.http.delete(`${this.apiUrl}/account/userdelete/${username}`).pipe(
      catchError(this.handleError)
    );
  }
